...
class UserCreate(BaseModel):
    ...
    No password: signing in is passwordless, so creating an account means
    registering the address with SuperTokens and emailing them a link.
    """
...
class UserResponse(BaseModel):
    ...
    #: The client company they work for. None for PestBase platform staff.
    client_id: Optional[str] = None
    #: PestBase's own staff, who manage the client list. Not a permission, so a
